...
public class UserConvertion {
    ...
    public static UserEntity userDtoToEntity(UserDto dto)
    {
        ...
        return new UserEntity(dto.getUserName(),dto.getPassWord(),dto.getUserId(),dto.isActive(),dto.getUserRole());
    }
    public static UserDto userEntityToDto(UserEntity entity)
    {
        return new UserDto(entity.getUserName(),entity.getPassWord(),entity.getUserId(),entity.isActive(),entity.getUserRole());
    }
}
